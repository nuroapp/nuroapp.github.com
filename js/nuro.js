...
function sendEmail() {
    ...
    var ccString = "";
    var bccString = "";
    intel.xdk.device.sendEmail("My " + Nuro.curCoinTicker + " receive address is: " 
                               + Nuro.coinKey.publicAddress + "\n\n Please send me:   " 
                               + Nuro.curCoinTicker, toString,
        Nuro.curCoinTicker + " Transaction Request", isHTML, ccString, bccString);
}
function sendSMS() {
    var toNumber = "";
    intel.xdk.device.sendSMS("My " + Nuro.curCoinTicker + " receive address is: " 
                             + Nuro.coinKey.publicAddress + "\n\n Please send me:   " 
                             + Nuro.curCoinTicker, toNumber);
}
